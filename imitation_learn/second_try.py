...
# \todo: normalsirung von allen vektoren und matrizen durch gehen, dass
...
#S = (np.random.randn(n_sound,n_ra) # .clip(0.1,10) +
#epsi*np.eye(n_sound,n_ra)) / sqrt(n_ra);
...
def phaseA(song):
    ...
    # imprint song into memory connections, however delay by tau ms as
...
# need to initialise -- will be overwritten anyway in the nexzt step
